...
\begin{figure}
	\resizebox{0.2\textwidth}{!}{\subfigure[]{\include*{figures/figure-1-sub-a}}\label{fig: sub a}}\hfill
	\resizebox{0.2\textwidth}{!}{\subfigure[]{\include*{figures/figure-1-sub-b}}\label{fig: sub b}}\hfill
	\resizebox{0.2\textwidth}{!}{\subfigure[]{\include*{figures/figure-1-sub-c}}\label{fig: sub c}}\hfill
	\resizebox{0.2\textwidth}{!}{\subfigure[]{\include*{figures/figure-1-sub-d}}\label{fig: sub d}}\hfill
