...
\noindent We will show in section \ref{sec: global opt} that this minimax game has a global optimum for $p_g = \pdat$. We will then show in \ref{sec: convergence} that %TODO: Algorithm 1 referencde
optimizes equation \ref{eq: equation 1}
